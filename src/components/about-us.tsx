...
const AboutUs: FunctionalComponent = () => {
  return (
    <section className="max-w-screen-xl mx-auto min-h-screen text-white p-16">
      ...
      <div className="md:flex w-full mt-16 gap-x-8 items-center justify-center">
        <div className="w-4/8 relative z-10">
          ...
          <p className="text-base md:text-2xl mt-2">
            ...
            público alvo. Acreditamos que conectar pessoas é fundamental para o
            sucesso do negócio e usamos o visual para potencializar os
            diferenciais.
          </p>
        </div>
      ...
      <div className="md:grid grid-cols-3 mt-8 md:mt-16">
        <div>
          ...
          <p className="text-base mt-4 leading-6">
            Construção de uma essência única que traga personalidade através de
            uma prposota de Valor e potencialize os diferenciais do produto ou
            serviço oferecido pela marca.
          </p>
        </div>
